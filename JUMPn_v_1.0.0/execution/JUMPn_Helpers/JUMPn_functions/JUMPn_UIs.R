...
Condensed_UI <- function(){
  fluidRow(
    ...
    column(4, class = 'text-center',
           ...
           box(status='primary', background = 'blue', width=40, height=10,
               id='second',
               div(style='display: inline-block;vertical-align:top;',fileInput("input_table", label = strong(HTML("Upload Input File containing gene list in column 2 and expression replicates from column 4 onward (.xlsx, .csv, .txt)")))),
               div(style='display: inline-block;vertical-align:top;',actionBttn(inputId = 'FileInfo', label=strong('i'),style='pill',color='default')),
    ...
    column(4,class = 'text-center',
           ...
           box(status='primary', background = 'blue', width=40, height=10,
               ...
               div(style='display: inline-block;vertical-align:top;',selectInput("PPIDatabases", h5(strong("Select a PPI Database to use for protein interactome analysis")),
