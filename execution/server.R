...
server <- function(input, output,session) {
    ...
    observeEvent(input$TransformInfo,{
        my_message <- 'By selecting "Yes", your expression data will be normalized by Log2 transformation. Transforming expression data in this manner helps to limit the systematic variation between replicates.
        If you have not already transformed your data, we highly recommend making this parameter "YES" to improve co-expression cluster detection.'
